...
import MyModal from "../PaymentSetup/MyModel";
...
const Cart = ({open, setOpen}) => {
    ...
    let [isCheckoutModalOpen, setCheckoutModalOpen] = useState(false)
    ...
    return (
        ...
        <MyModal isOpen={isCheckoutModalOpen} setIsOpen={setCheckoutModalOpen} />
      </Dialog>
    </Transition.Root>
    );
};
