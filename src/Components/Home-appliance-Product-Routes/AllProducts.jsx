...
const AllProducts = () => {
    ...
    return (
        <div>
            {
                dataRandom === '' ? <h1 className="text-2xl font-semibold min-h-screen w-full justify-center items-center flex">There is no data</h1> :
                    <div className='grid lg:grid-cols-3 md:grid-cols-2 gap-10 my-4 sm:px-0 px-5'>
                        {
                            dataRandom.map(w => <div key={w?._id}>
                                <div className="card w-full h-fit bg-white shadow-xl">
                                    ...
                                    <div className="card-body">
                                        ...
                                        <hr/>
                                        <div className="text-center text-xl font-semibold text-red-600 my-4 flex gap-3">
                                            <div>Price:</div>
