...
const OWalton = () => {
    ...
    const data = products.filter(data => data.category === 'oven' && data.brands === 'walton');

    const handleAddtoCart = (waltonid) => {

        const { name, image, price, modelname } = products.find(product => product._id === waltonid);
