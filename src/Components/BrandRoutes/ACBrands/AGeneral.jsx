...
const AGeneral = () => {
    ...
    const ACGeneral = products.filter(data => data.category === 'ac' && data.brands === 'general');

    const handleAddtoCart = (Generalid) => {

        const { name, image, price, modelname } = products.find(product => product._id === Generalid);
