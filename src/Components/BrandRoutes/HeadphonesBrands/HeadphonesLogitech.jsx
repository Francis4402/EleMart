...
const HeadphonesLogitech = () => {
    const axiosPublic = useAxiosPublic();
    const [products,refetch] = useCategory();

    const data = products.filter(data => data.categories === 'headphones' && data.brands === 'logitech');

    const handleAddtoCart = (logitechid) => {

        const { name, image, price, modelname } = products.find(product => product._id === logitechid);
...
export default HeadphonesLogitech;