...
const HeadphoneApple = () => {
    const axiosPublic = useAxiosPublic();
    const [products] = useCategory();

    const data = products.filter(data => data.categories === 'headphones' && data.brands === 'apple');

    const handleAddtoCart = (AppleHid) => {

        const { name, image, price, modelname } = products.find(product => product._id === AppleHid);
