...
const HeadphonesGamdias = () => {

    const axiosPublic = useAxiosPublic();
    const [products,refetch] = useCategory();

    const data = products.filter(data => data.categories === 'headphones' && data.brands === 'gamdias');

    const handleAddtoCart = (gameDiasid) => {

        const { name, image, price, modelname } = products.find(product => product._id === gameDiasid);
...
export default HeadphonesGamdias;