...
const Playstation = () => {
    ...
    const data = products.filter(data => data.categories === 'gameconsole' && data.brands === 'playstation');
    ...
    return (
        <div>
            {
                data === '' ? <h1 className="text-2xl font-semibold min-h-screen w-full justify-center items-center flex">There is no data</h1> :
